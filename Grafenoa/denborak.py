...
calculos = {
    'DFPT': {
        '2x2x1': os.path.join(HOME, 'DFPT','2x2x1'),
        '4x4x1': os.path.join(HOME, 'DFPT','4x4x1'),
        '7x7x1': os.path.join(HOME, 'DFPT','7x7x1'),
    },
    'DF': {
        '2x2x1': os.path.join(HOME, 'DF', '2x2x1'),
        '4x4x1': os.path.join(HOME, 'DF', '4x4x1'),
        '7x7x1': os.path.join(HOME, 'DF', '7x7x1')
    },
}
